  ...
  return (
    <>
      ...
      <div className="admin-layout">
        ...
        {/* Management & Broadcaster */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginBottom: '24px' }}>
          
          <AdminDisasterManager disasters={disasters} setDisasters={setDisasters} />
          
          <AdminShelterManager shelters={shelters} setShelters={setShelters} />
          ...
          <div className="admin-section">
            ...
            <form className="broadcast-form" onSubmit={handleBroadcast}>
              ...
              <div className="form-group" style={{ marginBottom: '12px' }}>
                <textarea id="alert-msg" className="form-textarea" placeholder="Message..." value={alertMsg} onChange={(e) => setAlertMsg(e.target.value)} rows={2} />
              </div>
              <button className="btn btn-primary btn-full" type="submit" disabled={alertSending || !alertTitle.trim() || !alertMsg.trim()}>
                {alertSending ? <><span className="spinner"></span> Broadcasting...</> : '📡 Push Alert'}
              </button>
            </form>
          </div>
        </div>
